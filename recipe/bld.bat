...
cmake %CMAKE_ARGS% ^
  ...
  -D CMAKE_CXX_FLAGS="-I\"%BUILD_PREFIX%\\opt\\compiler\\include\" %CXXFLAGS%" ^
  ...
  -D OpenMP_C_FLAGS="-Xclang;-fopenmp;-I\"%BUILD_PREFIX%\\opt\\compiler\\include\"" ^
  -D OpenMP_C_LIB_NAMES="libiomp5md" ^
  -D OpenMP_CXX_FLAGS="-Xclang;-fopenmp;-I\"%BUILD_PREFIX%\\opt\\compiler\\include\"" ^
